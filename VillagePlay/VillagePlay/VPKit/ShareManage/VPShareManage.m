    ...
    switch (channelType) {
        case VPChannelTypeAPP:{
            ...
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:@"下乡客-带你玩转乡村"
                                  descr:@"下乡客，为您精心推荐最美乡村、最特色民宿、周边乡村游玩攻略、乡村特色旅游活动…再也不愁周末去哪儿"
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:@"http://apipage.xiaxiangke.com/edm/appdownload/index.html"];
        }break;
        case VPChannelTypeGift:{
#ifdef DEBUG
            
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:@"您有500元优惠券未领取！"
                                  descr:@"新用户注册下乡客，即可获赠500元旅游优惠券，马上开启你的快乐之旅吧！"
                                  thumImage:[UIImage imageNamed:@"giftShare.jpg"]
                                  shareUrl:[NSString stringWithFormat:@"http://apipage.xiaxiangke.com/edm/yqyl1/voucher1.html?userid=%@",title]];
#else
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:@"您有500元优惠券未领取！"
                                  descr:@"新用户注册下乡客，即可获赠500元旅游优惠券，马上开启你的快乐之旅吧！"
                                  thumImage:[UIImage imageNamed:@"giftShare.jpg"]
                                  shareUrl:[NSString stringWithFormat:@"http://apipage.xiaxiangke.com/edm/yqyl/voucher1.html?userid=%@",title]];
#endif
        ...
        case VPChannelTypeTravel:{
            ...
            shareWebpageObject = [VPShareManage
                                  ...
                                  descr:[NSString stringWithFormat:@"我在下乡客参加%@活动!活动太火爆，要使劲戳才能报上名哦~",descr]
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:[NSString stringWithFormat:@"http://apipage.xiaxiangke.com/mobile/activeinfo.aspx?id=%@",shareUrl]];
        }break;
        case VPChannelTypeHotel:{
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:title
                                  descr:@"Hi，下乡客能在线预定民宿了，这么漂亮的民宿，你不来，她会一直等~"
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:[NSString stringWithFormat:@"http://apipage.xiaxiangke.com/homestay/hotelDetail.html?hid=%@",shareUrl]];
        }break;
        case VPChannelTypeTicket:{
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:title
                                  descr:@"Hi，下乡客能在线预订门票了，实惠又方便！"
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:[NSString stringWithFormat:@"http://apipage.xiaxiangke.com/ticket/ticketinfo.aspx?id=%@",shareUrl]];
        }break;
        case VPChannelTypeVillage:{
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:title
                                  descr:@"Hi，我在下乡客发现了这个能让你眼放绿光的地方，你快来啊！"
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:[NSString stringWithFormat:@"http://m.xiaxk.com/index.php/mobile/ShareV5/Villagedetail?id=%@",shareUrl]];
        }break;
        case VPChannelTypeMagazine:{
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:title
                                  descr:[NSString stringWithFormat:@"Hi，下乡客%@微刊简直美醉了！图美文美音乐美，看的我骨头都酥了！",title]
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:shareUrl];
        }break;
        case VPChannelTypeTopic:{
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:title
                                  descr:@"Hi，下乡客MM使出洪荒之力的倾情推荐，你不看，她会哭的~"
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:shareUrl];
        }break;
        case VPChannelTypeLive:{
            shareWebpageObject = [VPShareManage
                                  shareWebPageObjectWithTitle:title
                                  descr:[NSString stringWithFormat:@"Hi，没到现场不是你的错，不看%@直播，就说不过去了哦~",descr]
                                  thumImage:[UIImage imageNamed:@"share"]
                                  shareUrl:shareUrl];
        }break;
        default:
...
+ (void)alertWithError:(NSError *)error
{
    ...
    if (!error) {
        ...
        if (error) {
            result = [NSString stringWithFormat:@"取消分享: %d\n",(int)error.code];
        }
        else{
...
+(NSString *)getShareSource:(VPChannelType)source shareId:(NSString *)idStr{
    NSString *shareURL = [VPShareManage getURL];
    //拼接内容
    shareURL = [shareURL stringByAppendingString:[VPShareManage getShareSource:source]];
    shareURL = [NSString stringWithFormat:@"%@?id=%@",shareURL,idStr];
    return shareURL;
}

+(NSString *)getShareSource:(VPChannelType)source{
    NSString * shareSource;
    switch (source) {
//        case ShareSourceTowndetail:{
//            shareSource = @"Towndetail";
//        }break;
        case VPChannelTypeTopic:{
            shareSource = @"Topicdetail";
        }break;
        case VPChannelTypeTravel:{
            shareSource = @"Activedetail";
        }break;
//        case ShareSourceTravelDetail:{
//            shareSource = @"TravelDetail";
//        }break;
        case VPChannelTypeVillage:{
            shareSource = @"Villagedetail";
        }break;
        default:
            break;
    }
